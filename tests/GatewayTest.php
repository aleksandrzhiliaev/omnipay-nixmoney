...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testPurchase()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Nixmoney\Message\PurchaseRequest', $request);
    ...
    public function testCompletePurchase()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Nixmoney\Message\CompletePurchaseRequest', $request);
    }
    ...
    public function testRefund()
    {
        ...
        $this->assertInstanceOf('\Omnipay\Nixmoney\Message\RefundRequest', $request);
